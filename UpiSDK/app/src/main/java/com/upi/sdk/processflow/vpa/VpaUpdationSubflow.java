 ...
 */
public class VpaUpdationSubflow implements ProcessSubflow {
    ...
    public void execute(Object o, final ProcessChain chain) {
        ...
        UppServices.UpdateVPA(vpa, new ServiceCallback<String>(String.class) {
            @Override
            public void onSuccess(String result) {
                chain.doNext("VPA updated successfully");
            }
