 ...
 */
public class UpdateSchedulePopulatorSubflow implements ProcessSubflow {

    @Override
    public void execute(Object o, final ProcessChain chain) {

        Schedule historyQuery = (Schedule)o;

        UppServices.updateSchedule(historyQuery, new ServiceCallback<Schedule>(Schedule.class) {
            @Override
            public void onSuccess(Schedule result) {
                // TODO We can convert the bean if required
                chain.doNext("Schedule updated successfully");
            }
