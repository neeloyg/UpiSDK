...
public class AbsPrefs {
	...
	public boolean shouldUpgradeDb() {
		return getBoolean("should_upgrade_db", true);
	}
	
	public void setShouldUpgradeDb(boolean shouldUpgradeDb) {
		setBoolean("should_upgrade_db", shouldUpgradeDb);
	}
