 ...
 */
public class TransactionHistoryDetailsSubflowByRefId implements ProcessSubflow {
    ...
    public void execute(final Object o, final ProcessChain chain) {
        ...
        UppServices.transactionHistoryDetailsByRefId(param, new ServiceCallback<TxnHistoryDetails>(TxnHistoryDetails.class) {
            @Override
