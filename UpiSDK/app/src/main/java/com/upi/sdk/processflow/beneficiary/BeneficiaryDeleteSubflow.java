...
public class BeneficiaryDeleteSubflow implements ProcessSubflow {
    ...
    public void execute(Object o, final ProcessChain chain) {
        ...
        UppServices.deleteBeneficiary(beneficiaryDetails, new ServiceCallback<String>(String.class) {
            @Override
            public void onSuccess(String result) {
                chain.doNext("Beneficiary deleted succesfully");
            }
