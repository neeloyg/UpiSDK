...
public class DeActivateVPASubflow implements ProcessSubflow {
    @Override
    public void execute(final Object o, final ProcessChain chain) {

        final InputActivateVPA param = (InputActivateVPA)o;

        UppServices.deActivateVPA(param, new ServiceCallback<String>(String.class) {

            @Override
            public void onSuccess(String result) {
                chain.doNext("VPA de-activated successfully");
            }
