 ...
 */
public class BankAccAdditionSubflowbyMobile implements ProcessSubflow {
    ...
    public void execute(Object o, final ProcessChain chain) {
        ...
        UppServices.AddBankAccountByMobile(linkAccount, new ServiceCallback<String>(String.class) {
            @Override
            public void onSuccess(String result) {
                chain.doNext("Bank account added succesfully");
            }
