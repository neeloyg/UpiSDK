 ...
 */
public class AddBeneficiarySubflow implements ProcessSubflow {
    ...
    public void execute(Object o, final ProcessChain chain) {
        ...
        UppServices.addBeneficiary(beneficiaryDetails, new ServiceCallback<String>(String.class) {
            @Override
            public void onSuccess(String result) {
                chain.doNext("Beneficiary added succesfully");
            }
